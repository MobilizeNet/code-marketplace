...
import (
	...
	"github.com/coder/code-marketplace/src/testutil"
)
...
func (s *memoryStorage) InstallNewExtensions(ctx context.Context) ([]string, string) {
	return []string{"fake-ext1.vsix"}, "Installing..."
}
