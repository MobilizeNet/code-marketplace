...
func server() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Use Openvsx as second marketplace
			externalMarketplace := &externalmarketplace.ExternalMarketplace{
	...
	cmd.Flags().StringVar(&address, "address", ":3001", "The address on which to serve the marketplace API.")
