...
type Storage interface {
	...
	// installNewExtensions goes to the new-extensions folder (inside of the extensions folder) and search for vsix files
	// if there are visx files then call the AddExtension function to create the expected strcutrue
	// for that extension. And delete the vsix file from the new-extensions dir.
	InstallNewExtensions(ctx context.Context) ([]string, string)
}
